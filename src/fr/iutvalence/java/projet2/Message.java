...
/**
 * La classe Message est utilisée pour représenter un mail, composé : d'un
 * objet, d'un expéditeur, d'un destinataire et d'un corps
 * 
 * @author pougem
 * 
 */
public class Message {
	 ...
	 * @param destinataire
	 *            l'adrese mail de destination
	 * @param corps
	 *            Le corps du mail (contenu)
	 */
	...
	public String toString() {
		return "Message [objet=" + this.objet + ", expediteur="
				+ this.expediteur + ", destinataire=" + this.destinataire
				+ ", corps=" + this.corps + "]";
	}
	...
	public int hashCode() {
		...
		int result = 1;
		result = prime * result
				+ ((this.corps == null) ? 0 : this.corps.hashCode());
		result = prime
				* result
				+ ((this.destinataire == null) ? 0 : this.destinataire
						.hashCode());
		result = prime * result
	...
	/**
	 * Deux messages sont considérés comme égaux s'ils ont le même objet, le
	 * même expéditeur, le même destinataire et le même corps
	 * 
	 * NB : nous sommes pour l'heure obligés de comparer les corps des messages
	 * pour l'égalité; sinon, il faudrait introduire une notion de date / heure
	 * d'envoi du message
	 * 
