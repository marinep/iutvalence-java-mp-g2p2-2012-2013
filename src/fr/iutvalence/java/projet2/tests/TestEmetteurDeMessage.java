...
/**
 * Fonction d'émission de message (flan) Envoie un mail à la console
 */
public class TestEmetteurDeMessage {

	/**
	 * Fonction de test qui affiche dans la console un message. Cela permet de
	 * tester si le message a été créé correctement.
	 * 
	 * @param args
	 */
